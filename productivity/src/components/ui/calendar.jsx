    ...
    (<DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-5 w-5 bg-transparent rounded p-0 opacity-50 hover:opacity-100 border-gray"
        ),
        ...
        day: cn(
          ...
          "h-7 w-7 p-0 font-normal rounded aria-selected:opacity-100"
        ),
        ...
        day_today: "bg-gray-200 bg-accent text-accent-foreground",
        day_outside:
